    ...
    return (
      <div className="App">
        ...
        <Hero
          ...
          description="This is the hero description text"
          heroImgSrc={heroImg}
        />
        <Section
          title="Hi I'm a section title"
          ...
          <div class="l-linelength-container">
            <TextPassage>
              <p>
                ...
                CMS. It should live within a container that caps the line length
                of the text to avoid a straining reading experience.
              </p>
